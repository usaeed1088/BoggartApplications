...
std::shared_ptr<Boggart::Boggart> CreateServer(std::string id)
{
	...
	boggart->Logger()->EnableLevel(Boggart::Logger::Level::Information);
	boggart->Logger()->EnableLevel(Boggart::Logger::Level::Warning);
...
{
	std::shared_ptr<Boggart::Boggart> boggart(new Boggart::Boggart("Mr.Client"));
